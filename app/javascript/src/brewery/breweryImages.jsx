...
const BreweryImages = ({ breweryImages, currentUser, handleShowConfirmModal }) => {
  return (
    <div
      ...
      {breweryImages.length > 0 ? (
        breweryImages.map((image, index) => (
          <figure className='figure col-7 col-sm-5 col-lg-4 d-flex flex-column border-end pe-3 pt-3' key={index}>
            <div className='user-image figure-img border' style={{ backgroundImage: `url(${image.upload})` }}></div>
